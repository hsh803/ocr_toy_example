...
## Data
1. Image: Unstructured mixed-script (Modern Korean + Hanja)
2. JSON: Structured data containing original (visual text), transcription (phonetic Korean) and metadata (task difficulty, language tags) to support multi-task learning
